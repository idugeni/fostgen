...
/**
 * GitHub's mark, inlined because lucide-react dropped brand icons in v1.
 * Path from GitHub's own Octicons set (MIT licensed).
 */
export function GithubMark({ className, ...rest }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 16 16"
      fill="currentColor"
